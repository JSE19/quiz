...
<html lang="en-US">
    <head>
        ...
        <meta charset="UTF-8" />
        <meta name="author" content="Grafil Computers - Online Examination System" />
        <meta name="description" content="Test Preparation Portal by Grafil Computers." />
        <meta name="keywords" content="Online Portal, Online Exam System, Grafil Computers" />
    ...
    <body>
        ...
        <header class="header">
            <div class="wrapper clearfix">
                <div class="logo">
                    <img src="<?php echo SITEURL; ?>/images/logo.png" alt="Grafil Logo" title="Online Examination System" />
                </div>
